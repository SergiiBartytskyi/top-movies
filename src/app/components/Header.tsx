...
const Header = ({}: HeaderProps) => {
  return (
    <header className="fixed left-1/2 top-0 z-50 mt-7 flex w-11/12 max-w-7xl -translate-x-1/2 justify-between items-center rounded-full bg-background/20  backdrop-blur-lg md:rounded-full">
